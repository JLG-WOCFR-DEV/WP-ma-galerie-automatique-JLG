...
class PluginBlockSettingsTest extends WP_UnitTestCase {
    ...
    public function test_prepare_block_settings_uses_defaults_for_missing_values(): void {
        ...
        $this->assertFalse( $result['showThumbsMobile'], 'Mobile thumbnails should be disabled until explicitly enabled.' );
        $this->assertFalse( $result['showZoom'], 'Zoom control should be disabled until explicitly enabled.' );
        $this->assertFalse( $result['showDownload'], 'Download control should be disabled until explicitly enabled.' );
        $this->assertFalse( $result['showShare'], 'Share control should be disabled until explicitly enabled.' );
        $this->assertFalse( $result['showCta'], 'CTA control should be disabled until explicitly enabled.' );
        $this->assertFalse( $result['showFullscreen'], 'Fullscreen control should be disabled until explicitly enabled.' );
    }
