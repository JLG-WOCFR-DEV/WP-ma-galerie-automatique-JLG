...
?>
<div class="wrap mga-admin-wrap" data-mga-theme-root>
    ...
    <form action="options.php" method="post">
        ...
        >
                ...
                <aside class="mga-settings-layout__sidebar">
                    <div class="mga-settings-toolbar components-card">
                        ...
                        <div class="mga-settings-toolbar__view" data-mga-view-toggle>
                            <label class="components-base-control__label" for="mga-settings-view-mode"><?php echo esc_html__( 'Mode d’affichage', 'lightbox-jlg' ); ?></label>
                            <select id="mga-settings-view-mode" class="components-select-control__input" data-mga-view-select>
                        ...
                        <div class="mga-settings-toolbar__theme" data-mga-theme-toggle>
                            <label class="components-base-control__label" for="mga-settings-theme"><?php echo esc_html__( 'Apparence', 'lightbox-jlg' ); ?></label>
                            <select id="mga-settings-theme" class="components-select-control__input" data-mga-theme-select>
                                <option value="auto"><?php echo esc_html__( 'Système', 'lightbox-jlg' ); ?></option>
                            ...
                            <p class="description"><?php echo esc_html__( 'Améliorez le contraste de l’interface ou alignez-la sur le mode sombre du système.', 'lightbox-jlg' ); ?></p>
                        </div>
                    </div>
                ...
                <div class="mga-settings-layout__content">
                    <div class="mga-live-preview components-card" data-mga-live-preview>
                    ...
                    <section
                        ...
                        class="mga-settings-section components-card"
